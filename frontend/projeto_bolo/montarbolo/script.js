$('#service').on('change', function() {
    ...
    if (value == 1) {
      ...
      $('#valor').html('<model-viewer src="assets/recheio/bolocilindro choco.glb" camera-controls auto-rotate ar ios-src="assets/recheio/bolocilindro choco.glb"/> <p><a href="./aabolo.html">Escolher cobertura</a></p>')
    } else if (value == 1.3) {
      $('#valor').html('<model-viewer src="assets/recheio/bolocilindro morango.glb" camera-controls auto-rotate ar ios-src="assets/recheio/bolocilindro morango.glb"/> <p><a href="./aabolo.html">Escolher cobertura</a></p>')
    } else if (value == 1.4) {
      $('#valor').html('<model-viewer src="assets/recheio/bolocilindro baunilha.glb" camera-controls auto-rotate ar ios-src="assets/recheio/bolocilindro baunilha.glb"/> <p><a href="./aabolo.html">Escolher cobertura</a></p>')
    } else if (value == 1.5) {
      $('#valor').html('<model-viewer src="assets/recheio/bolocilindro abacaxi.glb" camera-controls auto-rotate ar ios-src="assets/recheio/bolocilindro abacaxi.glb"/> <p><a href="./aabolo.html">Escolher cobertura</a></p>')
    } else if (value == 2.1) {
      $('#valor').html('<model-viewer src="assets/recheio/boloretangulo limao.glb" camera-controls auto-rotate ar ios-src="assets/recheio/boloretangulo limao.glb"/> <p><a href="./bbbolo.html">Escolher cobertura</a></p>')
    } else if (value == 2.2) {
      $('#valor').html('<model-viewer src="assets/recheio/boloretangulo choco.glb" camera-controls auto-rotate ar ios-src="assets/recheio/boloretangulo choco.glb"/> <p><a href="./bbbolo.html">Escolher cobertura</a></p>')
    } else if (value == 2.3) {
      $('#valor').html('<model-viewer src="assets/recheio/boloretangulo morango.glb" camera-controls auto-rotate ar ios-src="assets/recheio/boloretangulo morango.glb"/> <p><a href="./bbbolo.html">Escolher cobertura</a></p>')
    } else if (value == 2.4) {
      $('#valor').html('<model-viewer src="assets/recheio/boloretangulo baunilha.glb" camera-controls auto-rotate ar ios-src="assets/recheio/boloretangulo baunilha.glb"/> <p><a href="./bbbolo.html">Escolher cobertura</a></p>')
    } else if (value == 2.5) {
